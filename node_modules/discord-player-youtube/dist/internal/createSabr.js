...
export async function createSabrStream(videoId, sabrOptions) {
    ...
    const dataSyncId = accountInfo?.contents?.contents[0]?.endpoint?.payload?.supportedTokens?.[2]
    ...
    const playbackOptions = sabrOptions ?? DEFAULT_OPTIONS;
